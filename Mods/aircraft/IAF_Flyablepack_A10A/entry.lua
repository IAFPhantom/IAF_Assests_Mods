...
-- A-10A cockpit
make_flyable('IAF_F_4E',current_mod_path..'/Cockpit/A10A/', {self_ID,'A10A',old = true}, current_mod_path..'/Comm.lua')

make_view_settings('IAF_F_4E_2000', ViewSettings, SnapViews)
make_flyable('IAF_F_4E_2000',current_mod_path..'/Cockpit/A10A/', {self_ID,'A10A',old = true}, current_mod_path..'/Comm.lua')
--

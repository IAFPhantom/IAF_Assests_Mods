...
--curr_target_size_y = 0.045
local sector_size   = curr_target_size_y * 1.2
--sector_size = 0.054

--local hud_tex_scale = 0.02 * 0.15 / sector_size
local hud_tex_scale = 2.22 * 0.15 / sector_size
--hud_tex_scale = 0.972
...
distance_sector.vertices1		= {{-0.05 * sector_size, -sector_size}, 
                                   ...
                                   {        sector_size, -sector_size}}
distance_sector.tex_params1		=  {0.514,0.5, hud_tex_scale, hud_tex_scale}
distance_sector.vertices2		= {{      -sector_size, -sector_size}, 
                                   {      -sector_size,  sector_size}, 
                                   {0.05 * sector_size,  sector_size}, 
                                   {0.05 * sector_size, -sector_size}}                                  
distance_sector.tex_params2		= {0.488, 0.5, hud_tex_scale, hud_tex_scale}

...
-- Rotor RPM
RotorRPM_needle_Bias = {{valmin = 0.0, valmax = 339.0, bias = math.rad(0.1)}}
RotorRPM_needle = {isLagElement = true, valmin = 0.0, valmax = 339.0, T1 = 0.2, bias = RotorRPM_needle_Bias,

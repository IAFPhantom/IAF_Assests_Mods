...
add_picture(LockOn_Options.script_path.."../IndicationTextures/notepad.dds")
...
txt_AutoPilot_mode.controllers	= {{"AutoPilot_mode"}}
...
txt_AutoPilot.controllers	= {{"AutoPilot"}}
...
txt_AutoPilot_key.controllers	= {{"AutoPilot"}}
...
txt_AutoPilot_KEEP_AS_IS.controllers	= {{"AutoPilot"}}
...
txt_AutoPilot_KEEP_AS_IS_key.controllers	= {{"AutoPilot"}}
...
txt_AutoPilot_H_AS_AB.controllers	= {{"AutoPilot"}}
...
txt_AutoPilot_H_AS_AB_key.controllers	= {{"AutoPilot"}}
...
txt_AutoPilot_TURN_IN.controllers	= {{"AutoPilot"}}
...
txt_AutoPilot_TURN_IN_key.controllers	= {{"AutoPilot"}}
...
txt_TacUnook_Key.value    	= "RC+RS+RA+P"
...
txt_CargoView			= CreateElement "ceStringPoly"
txt_CargoView.name		= "txt_CargoView"
txt_CargoView.material	= "font_hints_kneeboard"
txt_CargoView.init_pos	= {cargo_label_x,  cargo_line6_y, 0}
txt_CargoView.value		= "CARGO VIEW COMBO"
txt_CargoView.alignment	= "RightCenter"
txt_CargoView.stringdefs	= predefined_font_0
txt_CargoView.controllers	= {{"show_cargo_status"}}
AddElement(txt_CargoView)

txt_CargoView_Key				= CreateElement "ceStringPoly"
txt_CargoView_Key.name		= "txt_CargoView_Key"
txt_CargoView_Key.material	= "font_hints_kneeboard_keys"
txt_CargoView_Key.init_pos	= {cargo_key_x,  cargo_line6_y, 0}
txt_CargoView_Key.value		= "LS+LA+Q"
txt_CargoView_Key.alignment	= "LeftCenter"
txt_CargoView_Key.stringdefs	= predefined_font_0
txt_CargoView_Key.controllers	= {{"show_cargo_status"}}
AddElement(txt_CargoView_Key)
...
txt_Cargo_Rope_Length.init_pos		= {cargo_label_x,  cargo_line7_y, 0}
...
txt_Cargo_Rope_Length_Value.init_pos	= {cargo_value_x,  cargo_line7_y, 0}
...
txt_Cargo_Status.init_pos		= {cargo_label_x,  cargo_line8_y, 0}
...
txt_Cargo_Mass_Value.init_pos		= {cargo_value_x,  cargo_line8_y, 0}

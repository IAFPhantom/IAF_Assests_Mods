...
push_start_command(delta_t_com,{device = devices.RADAR_ALTIMETER, action = device_commands.Button_2,value = 0.3, message= _("RADAR ALTIMETER ON"),message_timeout = std_message_timeout})

...
function default_axis_limited(hint_,device_,command_,arg_,gain_,updatable_,relative_, _arg_lim)
...
function multiposition_switch(hint_,device_,command_,arg_,count_,delta_,min_,inverted_)
...
elements["VM-SWITCHER-PTR"]				= multiposition_switch(_("DC Voltmeter Selector"), devices.ELEC_INTERFACE, device_commands.Button_4, 218, 5, 0.1,0.0,-1)
...
elements["PHASE-SWITCHER-PTR"]			= multiposition_switch(_("AC Voltmeter Selector"), devices.ELEC_INTERFACE, device_commands.Button_7, 214, 3, 0.1,0.0,-1)
...
elements["IFF-API-PTR"]					= default_2_position_tumb(_("CB IFF APX 1 (N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd, 285)
elements["IFF-APX-PTR"]					= default_2_position_tumb(_("CB IFF APX 2 (N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 1, 287)
elements["PROX-WARN-PTR"]				= default_2_position_tumb(_("CB Prox. warn.(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 2, 289)
elements["MARKER-BEACON-PTR"]			= default_2_position_tumb(_("CB Marker beacon, ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 3, 291)
elements["VHF-NAV-PTR"]					= default_2_position_tumb(_("CB VHF Nav. (ARN-82), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 4, 293)
elements["LF-NAV-PTR"]					= default_2_position_tumb(_("CB LF Nav. (ARN-83), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 5, 295)
elements["INTER-COM-CPLT-PTR"]			= default_2_position_tumb(_("CB Intercom CPLT(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 6, 297)
elements["INTER-COM-PLT-PTR"]			= default_2_position_tumb(_("CB Intercom PLT, ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 7, 299)
elements["ARC-102-PTR"]					= default_2_position_tumb(_("CB ARC-102 HF Static INVTR(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 8, 349)
elements["HF-ANT-PTR"]					= default_2_position_tumb(_("CB HF ANT COUPLR(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 9, 351)
elements["HF-ARC-102-PTR"]				= default_2_position_tumb(_("CB HF ARC-102(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 10, 353)
elements["FM-ARC-54-PTR"]				= default_2_position_tumb(_("CB FM Radio, ON/OFF"),				devices.ELEC_INTERFACE, cb_start_cmd + 11, 355)
elements["UHF-ARC-51-PTR"]				= default_2_position_tumb(_("CB UHF Radio, ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 12, 357)
elements["FM2-ARC-114-PTR"]				= default_2_position_tumb(_("CB FM 2 Radio(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 13, 359)
elements["VXFXCVR-COMM-PTR"]			= default_2_position_tumb(_("CB VHF AM Radio, ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 14, 361)
-- here needs to be set for " ALTM APN 209"
elements["PITOT-TUBE-PTR"]				= default_2_position_tumb(_("CB Pitot tube(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 16, 321)
-- here needs to be set for "PILOT 5 VOLT LIGHTS"
elements["RESCUE-CONT-PTR"]			    = default_2_position_tumb(_("CB Rescue hoist CTL(N/F), ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 18, 345)
elements["RESCUE-CABLE-PTR"]			= default_2_position_tumb(_("CB Rescue hoist cable cutter N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 19, 347)
----------------------------------------------------------------------------- Essential BUS. line 2----------------------------------------------------------------------
elements["WIND-SHIELD-CB-PTR"]			= default_2_position_tumb(_("CB Wind wiper CPLT, ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 20, 301)
elements["WIND-SHIELD2-CB-PTR"]			= default_2_position_tumb(_("CB Wind wiper PLT, ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 21, 303)
elements["K-Y20-PTR"]					= default_2_position_tumb(_("CB KY-28 voice security(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 22, 305)
elements["STARTER-RELAY-PTR"]			= default_2_position_tumb(_("CB Starter Relay(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 23, 403)
elements["SEARCH-LIGHT-PTR"]			= default_2_position_tumb(_("CB Search light power(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 24, 307)
elements["LDG-LIGHT-PTR"]				= default_2_position_tumb(_("CB Landing light power(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 25, 309)
elements["LDG-SEARCH-PTR"]				= default_2_position_tumb(_("CB Landing & Search light control(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 26, 311)
elements["ANTI-COLL-CB-PTR"]			= default_2_position_tumb(_("CB Anticollision light(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 27, 313)
elements["FUS-LIGHTS-PTR"]				= default_2_position_tumb(_("CB Fuselage lights(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 28, 363)
elements["NAV-LIGHTS-PTR"]				= default_2_position_tumb(_("CB Navigation lights(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 29, 365)
elements["DOME-LIGHTS-PTR"]				= default_2_position_tumb(_("CB Dome lights(N/F), ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 30, 367)
elements["COCKPIT-LIGHTS-PTR"]			= default_2_position_tumb(_("CB Cockpit lights(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 31, 369)
elements["CAUTION-LIGHTS-PTR"]			= default_2_position_tumb(_("CB Caution lights(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 32, 371)
elements["CONSOLE-LIGHTS-PTR"]			= default_2_position_tumb(_("CB Console lights(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 33, 373)
elements["INST-PANEL-LIGHTS-PTR"]		= default_2_position_tumb(_("CB INST Panel lights(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 34, 375)
elements["INST-SEC-LIGHTS-PTR"]			= default_2_position_tumb(_("CB INST SEC lights(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 35, 377)
elements["OUTLET-VALVE-PTR"]			= default_2_position_tumb(_("CB Cabin heater (Outlet valve)(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 36, 323)
elements["AIR-VALVE-PTR"]				= default_2_position_tumb(_("CB Cabin heater (Air valve)(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 37, 325)
elements["RESCUE-POWER-PTR"]			= default_2_position_tumb(_("CB Rescue hoist PWR(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 38, 343)
------------------------------------------------------------------------- Essential BUS. line 3-----------------------------------------------------------------------
elements["RPM-WARN-PTR"]				= default_2_position_tumb(_("CB RPM Warning system(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 39, 327)
elements["ANTI-ICE-PTR"]				= default_2_position_tumb(_("CB Engine anti-ice(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 40, 329)
elements["FIRE-PTR"]					= default_2_position_tumb(_("CB Fire detector(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 41, 331)
elements["LH-FUEL-PTR"]					= default_2_position_tumb(_("CB LH fuel boost pump(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 42, 333)
elements["TURN-SLIP-PTR"]				= default_2_position_tumb(_("CB Turn & Slip indicator, ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 43, 335)
elements["TEMP-IND-PTR"]				= default_2_position_tumb(_("CB TEMP indicator(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 44, 337)
elements["HYD-CONT-CB-PTR"]				= default_2_position_tumb(_("CB HYD Control(N/F), ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 45, 339)
elements["FORCE-TRIM-CB-PTR"]			= default_2_position_tumb(_("CB FORCE Trim(N/F), ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 47, 341)
elements["CARGO-HOOK-PTR"]			    = default_2_position_tumb(_("CB Cargo hook release(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 48, 379)
elements["EXT-STORES-PTR"]			    = default_2_position_tumb(_("CB EXT Stores jettison(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 49, 381)
elements["SPARE-INVTR-PTR"]				= default_2_position_tumb(_("CB Spare inverter PWR(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 50, 383)
elements["INVTR-PTR"]					= default_2_position_tumb(_("CB Inverter CTRL (N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 51, 385)
elements["MAIN-INVTR-PTR"]				= default_2_position_tumb(_("CB Main inverter PWR(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 52, 387)
elements["GEN-BUS-PTR"]					= default_2_position_tumb(_("CB Generator & Bus Reset(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 53, 389)
elements["STBY-GEN-PTR"]				= default_2_position_tumb(_("CB STBY Generator Field(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 54, 391)
elements["GOV-CONT-PTR"]				= default_2_position_tumb(_("CB Governor Control(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 55, 393)
elements["IDLE-STOP-PTR"]				= default_2_position_tumb(_("CB IDLE Stop release(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 56, 395)
elements["RH-FUEL-PTR"]					= default_2_position_tumb(_("CB RH fuel boost pump(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 57, 397)
elements["FUEL-TRANS-PTR"]				= default_2_position_tumb(_("CB Fuel TRANS(N/F), ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 58, 399)
elements["FUEL-VALVES-PTR"]				= default_2_position_tumb(_("CB Fuel valves(N/F), ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 59, 401)
---------------------------------------------------------------------- Non Essential BUS-----------------------------------------------------------------------------
elements["HEATED-BLANKET-PTR"]			= default_2_position_tumb(_("CB Heated blanket 1(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 60, 315)
elements["HEATED-BLANKET2-PTR"]			= default_2_position_tumb(_("CB Heated blanket 2(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 61, 317)
elements["VOLT-METER-PTR"]				= default_2_position_tumb(_("CB Voltmeter Non Ess Bus(N/F), ON/OFF"),	devices.ELEC_INTERFACE, cb_start_cmd + 62, 319)
--------------------------------------------------------------------- other circuit breakers---------------------------------------------------------------------------
elements["IGNITER-SOL-PTR"]			    = default_2_position_tumb(_("CB Ignition system(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 64, 405)
----------------------------------------------------------------------AC BUS circuit breakers------------------------------------------------------------------------
elements["PILOT-ATTD1-PTR"]			    = default_2_position_tumb(_("CB Pilot ATTD1(N/F), ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 65, 423)
elements["PILOT-ATTD2-PTR"]			    = default_2_position_tumb(_("CB Pilot ATTD2(N/F), ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 66, 424)
elements["COPILOT-ATTD1-PTR"]			= default_2_position_tumb(_("CB Copilot ATTD1(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 67, 425)
elements["COPILOT-ATTD2--PTR"]			= default_2_position_tumb(_("CB Copilot ATTD2(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 68, 426)
elements["GYRO-CMPS-PTR"]			    = default_2_position_tumb(_("CB Gyro Cmps(N/F), ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 69, 427)
elements["FUEL-QTY-PTR"]			    = default_2_position_tumb(_("CB Fuel Quantity(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 70, 428)
elements["TRANS-28V-PTR"]			    = default_2_position_tumb(_("CB 28V Trans(N/F), ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 71, 429)
elements["FAIL-RELAY-PTR"]			    = default_2_position_tumb(_("CB Fail Relay(N/F), ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 72, 430)
elements["PRESS-FUEL-PTR"]			    = default_2_position_tumb(_("CB Pressure Fuel(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 73, 431)
elements["PRESS-TORQ-PTR"]			    = default_2_position_tumb(_("CB Pressure Torque(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 74, 432)
elements["PRESS-XMSN-PTR"]			    = default_2_position_tumb(_("CB Pressure XMSN(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 75, 433)
elements["PRESS-ENG-PTR"]			    = default_2_position_tumb(_("CB Pressure Eng(N/F), ON/OFF"),		devices.ELEC_INTERFACE, cb_start_cmd + 76, 434)
elements["COURSE-IND-PTR"]			    = default_2_position_tumb(_("CB Course Ind(N/F), ON/OFF"),			devices.ELEC_INTERFACE, cb_start_cmd + 77, 435)
...
elements["MAIN-GEN-SWITCHER-COVER-PTR"]	= default_2_position_tumb(_("Main generator switch cover, OPEN/CLOSE"), devices.ELEC_INTERFACE, device_commands.Button_19, 217)
...
elements["MASTER-CONTROL-PTR"]			= multiposition_switch(_("Master Knob, OFF/STBY/LOW/NORM/EMER"), devices.IFF, device_commands.Button_8, 59, 5, 0.1)
...
--elements["ENGINE-BTN-2-PTR"]			= default_button(_("Engine Start Button") , devices.ENGINE_INTERFACE, device_commands.Button_13, 213)
...
elements["PITCH-ADJUSTMENT-PTR"]	= default_axis(_("Attitude Indicator Pitch Trim Knob"), devices.ADI_OPERATOR, device_commands.Button_2, 146, 0,0.1, false, true)

--Pilot's Attitude indicator
elements["PILOT-ATT-ROLL-ADJ-KNOB-PTR"]	= default_axis(_("Attitude Indicator Pitch Trim Knob"), devices.ADI_PILOT, device_commands.Button_1, 145, 0,0.1, false, true)
elements["PILOT-ATT-PITCH-ADJ-KNOB-PTR"]= default_axis(_("Attitude Indicator Roll Trim Knob"), devices.ADI_PILOT, device_commands.Button_2, 144, 0,0.1, false, true)
...
elements["SDP-VOLUME-CONTROL-PTR"]  = default_axis_limited(_("Intercom Volume Knob"),devices.INTERCOM,device_commands.Button_7,29,-0.1,true,false,{0.3,1.0})
...
elements["TRANSMIT-INTERPHONE-SWITCH-PTR"]	= multiposition_switch(_("Intercom Mode (PVT - hot line; INT - interphone; 1 - VHF FM transmitter; 2 - UHF transmitter; 3 - VHF AM transmitter; 4 - Not used)"),devices.INTERCOM,device_commands.Button_8,30,6,0.1,0.0,-1)
...
elements["10-MHZ-CONTROL-PTR"] 		= default_axis_limited(_("10 MHz Selector"), devices.UHF_ARC_51, device_commands.Button_2, 18, -0.1,false,true, {0, 1})
elements["1-MHZ-CONTROL-PTR"] 		= default_axis_limited(_("1 MHz Selector"), devices.UHF_ARC_51, device_commands.Button_3, 19, -0.1,false,true, {0, 1})
elements["0.05-MHZ-CONTROL-PTR"] 	= default_axis_limited(_("50 kHz Selector"), devices.UHF_ARC_51, device_commands.Button_4, 20, -0.1,false,true, {0, 1})

elements["MODE-SELECT-SWITCH-PTR"] 	   = multiposition_switch(_("Frequency Mode Dial") , devices.UHF_ARC_51, device_commands.Button_5, 15, 3, 0.1)
elements["FUNCTION-SELECT-SWITCH-PTR"] = multiposition_switch(_("Function Dial") , devices.UHF_ARC_51, device_commands.Button_6, 17, 4, 0.1)
...
--VHF ARC 131
elements["FREQUENCY-SELECTOR-1-PTR"]	= multiposition_switch_limited(_("Frequency Tens MHz Selector") , devices.VHF_ARC_131, device_commands.Button_1, 31, 5, 0.1,0.3)
elements["FREQUENCY-SELECTOR-2-PTR"]	= multiposition_switch_limited(_("Frequency Ones MHz Selector") , devices.VHF_ARC_131, device_commands.Button_2, 32, 10, 0.1)
elements["FREQUENCY-SELECTOR-3-PTR"] 	= multiposition_switch_limited(_("Frequency Decimals MHz Selector") , devices.VHF_ARC_131, device_commands.Button_3, 33, 10, 0.1)
elements["FREQUENCY-SELECTOR-4-PTR"] 	= multiposition_switch_limited(_("Frequency Hundredths MHz Selector") , devices.VHF_ARC_131, device_commands.Button_4, 34, 2, 0.1)
...
elements["VOLUME-CONTROL-PTR"]  		= default_axis_limited(_("Volume Knob"),devices.VHF_ARC_131,device_commands.Button_6,37,-0.1,true,false,{0.3,1.0})
...
--Nav lights
elements["NVG-POSITION-LTS-PTR"]			= multiposition_switch(_("Navigation Lights Switch, OFF/1/2/3/4/BRT") , devices.NAVLIGHT_SYSTEM, device_commands.Button_1, 222, 6, 0.1)
...
elements["BLEND-AIR-PTR"]				= multiposition_switch(_("Bleed Air Switch, OFF/1/2/3/4") , devices.HEATING_SYSTEM, device_commands.Button_1, 236, 5, 0.1)
...
elements["RKT-PAIR-PTR"]				= multiposition_switch(_("Rocket Pair Selector Switch") , devices.WEAPON_SYS, device_commands.Button_11, 257, 8, 0.1)
...
elements["JETT-COVER-PTR"]				= default_3_position_tumb(_("Jettison Switch Cover, OPEN/CLOSE"), devices.WEAPON_SYS, device_commands.Button_13, 259)
...
elements["PILOT-SIGHT-POS-PTR"] = default_2_position_tumb(_("Pilot Sight, Armed/Safe"), devices.PILOT_SIGHT, device_commands.Button_5, 0)
...
elements["PILOT-SIGHT-BRIGHT-PTR"] = default_axis(_("Pilot Sighting Station Intensity Knob"),devices.PILOT_SIGHT, device_commands.Button_1, 440, 0.0, 0.1, false, false)
elements["PILOT-SIGHT-BRIGHT-PTR"].updatable = true
elements["PILOT-SIGHT-SCALE-PTR"] 	= default_axis_limited(_("Sight Elevation Knob"), devices.PILOT_SIGHT, device_commands.Button_3, 441, 0.1, true, false, {-1.0, 1.0})
...
elements["WIPERS-PTR"]						= IFF_multiposition_spring_switch(_("Wipers Speed Switch, PARK/OFF/LOW/MED/HIGH"), devices.CPT_MECH, device_commands.Button_1,229) --multiposition_switch(_("Wipers Speed") , devices.CPT_MECH, device_commands.Button_1, 229, 5, 0.1)
...
elements["RIPPLE-FIRE-COVER-PTR"]	    = default_2_position_tumb(_("Ripple Fire Cover, OPEN/CLOSE"), devices.XM_130, device_commands.Button_1, 450)

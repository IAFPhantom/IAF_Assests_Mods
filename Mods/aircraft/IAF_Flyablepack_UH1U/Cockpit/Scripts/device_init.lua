...
creators[devices.ARCADE] =          {"UH1H::avArcadeRadar_UH1H",
									LockOn_Options.script_path.."ARCADE/arcade.lua",
									{{"weapon_system",devices.WEAPON_SYS}},
									LockOn_Options.script_path.."ARCADE/arcade_commands.lua"
									}							   
end
			
tv_map_render_id ={1, 2, 3, 4};

indicators[#indicators + 1] = {"UH1H::ccControlsIndicator", LockOn_Options.script_path.."ControlsIndicator/ControlsIndicator.lua"}  
...
if LockOn_Options.flight.easy_radar then                                            
	indicators[#indicators + 1] = {"UH1H::ccArcadeRadar_UH1H"   ,LockOn_Options.script_path.."ARCADE/arcade_indicator.lua",devices.ARCADE}
end

...
{action = device_commands.Button_42, cockpit_device_id = devices.WEAPON_SYS, name = _('Gun Left/Right')},
{action = device_commands.Button_41, cockpit_device_id = devices.WEAPON_SYS, name = _('Gun Up/Down')},

...
{combos = {{key = 'MOUSE_X'}}, action = device_commands.Button_42, cockpit_device_id = devices.WEAPON_SYS, name = _('Gun Left/Right')},
{combos = {{key = 'MOUSE_Y'}}, action = device_commands.Button_41, cockpit_device_id = devices.WEAPON_SYS, name = _('Gun Up/Down')},

{action = device_commands.Button_43, cockpit_device_id = devices.WEAPON_SYS, name = _('Camera Horizontal View')},
{action = device_commands.Button_44, cockpit_device_id = devices.WEAPON_SYS, name = _('Camera Vertical View')},
